...
class HotFriendBean {
  ...
  HotFriendBean.fromJson(dynamic json) {
    if (json["data"] != null) {
      data = [];
      json["data"].forEach((v) {
        data.add(HotFriend.fromJson(v));
      });
    }
...
class HotFriend {
  ...
  HotFriend.fromJson(dynamic json) {
