...
import 'package:flutter_demo/bean/project_bean.dart';
...
class _ProjectPageState extends State<ProjectPage> {
  bool isLoading = true;
  List<ProjectItem> projectTreeList;
    ...
    return new DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            bottom: new TabBar(
              isScrollable: true,
              tabs: projectTreeList.map((ProjectItem child) {
                return new Tab(
                  text: child.name,
                );
              }).toList(),
          ...
          body: new TabBarView(
            children: projectTreeList.map((ProjectItem child) {
              return ListPage(
                cid: child.id,
              );
            }).toList(),
  ...
  void getTitle() async {
    ...
    var item = new ProjectBean.fromJson(response);
    setState(() {
